...
Message.create(body: "Message one", user_id: 1)
Message.create(body: "Message two", user_id: 2)
Message.create(body: "Message three", user_id: 3)
Message.create(body: "Message four", user_id: 4)
Message.create(body: "Message five", user_id: 5)
